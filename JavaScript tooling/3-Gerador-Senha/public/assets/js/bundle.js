...
var qtdeCaracter = document.querySelector('.qtde-caracter');
...
function gera() {
  var senha = (0,_geradores__WEBPACK_IMPORTED_MODULE_0__["default"])(qtdeCaracter.value, chkMaiuscula.checked, chkMinusculas.checked, chkNumeros.checked, chkSimbolos.checked);
...
function geraSenha(qtd, maiuscula, minuscula, numeros, simbolos) {
  var senhaArray = [];
  console.log(qtd, maiuscula, minuscula, numeros, simbolos);
  qtd = Number(qtd);
  for (var i = 0; i < qtd; i++) {
